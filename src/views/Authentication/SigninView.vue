...
const handleSignIn = () => {
  // Check if credentials match the fake user
  console.log(email.value , fakeUser.email)
  console.log(password.value , fakeUser.password)
  if (email.value === fakeUser.email && password.value === fakeUser.password) {
    // Simulate authentication success (you can update isAuthenticated here)
    localStorage.setItem('isAuthenticated', 'true')
    console.log('isAuthenticated: true')

    // Redirect to the eCommerce dashboard
    router.push('/')
  } else {
...
<template>
  <DefaultLayout>
    ...
    <DefaultAuthCard subtitle="Start for free" title="Sign In to Medico Inteligente">
      <form @submit.prevent="handleSignIn">
        
        <!-- Email input field (testing version) -->
        <div>
        ...
        <!-- <InputGroup label="Email" type="email" placeholder="Enter your email" v-model="email"> 
          ...
          >
           ...
           <!-- Password input field (testing version) -->
        <div>
